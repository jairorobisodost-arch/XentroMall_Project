...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Fetch tradename for descriptive filenames
        $stmtT = $pdo->prepare("SELECT tradename FROM tenant_details WHERE user_id = ?");
        $stmtT->execute([$user_id]);
        $tradename = $stmtT->fetchColumn() ?: 'Unknown';
...
<body class="min-h-screen text-slate-800">
    ...
    <header class="fixed top-0 inset-x-0 z-40">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <nav
                class="mt-4 flex items-center justify-between rounded-2xl bg-white/10 backdrop-blur-xl ring-1 ring-white/15 px-4 py-3 shadow-lg">
                <a href="index.php" class="flex items-center gap-3">
                    <span
                        class="h-10 w-10 overflow-hidden rounded-xl ring-1 ring-white/30 bg-white/70 flex items-center justify-center shadow">
                ...
                <a href="user_stall_page.php"
                    class="inline-flex items-center gap-2 rounded-lg bg-white/10 backdrop-blur px-4 py-2 text-white hover:bg-white/20 transition">
    ...
    <div class="container mx-auto px-4 pt-28 pb-12">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8">
                <div
                    class="inline-flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-xl ring-1 ring-white/20 px-4 py-2 mb-6">
                    <i class="fas fa-redo text-emerald-400"></i>
                    <span class="text-sm font-medium text-white/90">Document Resubmission</span>
                </div>
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">
                    Resubmit <span
                        class="bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-transparent">Requirements</span>
                </h1>
                <p class="text-lg text-white/80 max-w-2xl mx-auto">Please upload all required documents for your
                    business type</p>
            </div>
                ...
                <form action="" class="space-y-8" enctype="multipart/form-data" method="POST">
                    ...
                    <div>
                        <label class="block text-slate-900 font-bold text-lg mb-4 flex items-center gap-2">
                            <div
                                class="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-emerald-500 text-white flex items-center justify-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <label
                                class="relative flex items-center justify-center cursor-pointer p-4 rounded-xl border-2 border-slate-300 hover:border-blue-500 transition-all group">
                                <input name="business_type" onclick="toggleRequirements()" required="" type="radio"
                                    value="corporation" class="absolute opacity-0" />
                                <div class="text-center">
                                    <i
                                        class="fas fa-building text-3xl text-slate-400 group-hover:text-blue-600 mb-2 transition"></i>
                                    <span
                                        class="block font-semibold text-slate-700 group-hover:text-blue-600 transition">Corporation</span>
                                </div>
                            </label>
                            <label
                                class="relative flex items-center justify-center cursor-pointer p-4 rounded-xl border-2 border-slate-300 hover:border-emerald-500 transition-all group">
                                <input name="business_type" onclick="toggleRequirements()" type="radio" value="sole"
                                    class="absolute opacity-0" />
                                <div class="text-center">
                                    <i
                                        class="fas fa-user-tie text-3xl text-slate-400 group-hover:text-emerald-600 mb-2 transition"></i>
                                    <span
                                        class="block font-semibold text-slate-700 group-hover:text-emerald-600 transition">Sole
                                        Proprietorship</span>
                                </div>
                            </label>
                            <label
                                class="relative flex items-center justify-center cursor-pointer p-4 rounded-xl border-2 border-slate-300 hover:border-violet-500 transition-all group">
                                <input name="business_type" onclick="toggleRequirements()" type="radio"
                                    value="franchisee" class="absolute opacity-0" />
                                <div class="text-center">
                                    <i
                                        class="fas fa-handshake text-3xl text-slate-400 group-hover:text-violet-600 mb-2 transition"></i>
                                    <span
                                        class="block font-semibold text-slate-700 group-hover:text-violet-600 transition">Franchisee</span>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="rounded-xl p-5 bg-gradient-to-br from-blue-50 to-emerald-50 border-2 border-blue-200"
                        ...
                        <div class="hidden" id="corporation-requirements">
                            ...
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>Letter of
                                        Intent/Concept Papers</span></li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>Company
                                        Profile</span></li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>SEC
                                        Registration</span></li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>Secretary's
                                        Certificate of Authorized Signatory</span></li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>BIR Form 2303</span>
                                </li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>2 Valid IDs with 3
                                        Specimen Signatures of Authorized Signatory</span></li>
                            </ul>
                        </div>
                        <div class="hidden" id="sole-requirements">
                            ...
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-start gap-2"><i
                                        ...
                                        Intent/Concept Papers</span></li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>DTI permit</span>
                                </li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>BIR Form 2303</span>
                                </li>
                        ...
                        <div class="hidden" id="franchisee-requirements">
                            ...
                            <ul class="space-y-2 text-slate-700">
                                <li class="flex items-start gap-2"><i
                                        ...
                                        Intent/Concept Papers</span></li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>Enrollment letter
                                        from Franchisor</span></li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>Photocopy of
                                        Franchise Agreement</span></li>
                                <li class="flex items-start gap-2"><i
                                        class="fas fa-check-circle text-emerald-500 mt-1"></i><span>BIR Form 2303</span>
                                </li>
                                <li class="flex items-start gap-2"><i
                        ...
                        <div id="corporation-files" class="hidden">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input
                                        class="w-full rounded-xl border-2 border-slate-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                        ...
                        <div id="sole-files" class="hidden">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input
                                        class="w-full rounded-xl border-2 border-slate-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
                        ...
                        <div id="franchisee-files" class="hidden">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input
                                        class="w-full rounded-xl border-2 border-slate-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition"
                    ...
                    <div class="flex flex-col md:flex-row gap-4 pt-6 border-t border-slate-200">
                        <button
                            class="flex-1 inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-emerald-500 hover:from-blue-700 hover:to-emerald-600 text-white px-8 py-3.5 rounded-xl font-semibold shadow-lg shadow-emerald-500/30 transition-all hover:scale-105"
                            type="submit">
                            <i class="fas fa-paper-plane"></i>
                            <span>Resubmit Documents</span>
                        </button>
                        <a class="flex-1 inline-flex items-center justify-center gap-2 bg-white/80 hover:bg-white text-slate-700 px-8 py-3.5 rounded-xl font-semibold shadow-lg transition-all hover:scale-105 border-2 border-slate-300"
