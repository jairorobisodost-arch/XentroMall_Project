    ...
    <div class="form-container">
        ...
        <?php if (!empty($_SESSION['work_permit_error_message'])): ?>
            <div class="message error">
                <?php echo htmlspecialchars($_SESSION['work_permit_error_message']);
    unset($_SESSION['work_permit_error_message']); ?>
            </div>
        <?php
endif; ?>
        ...
        <?php if (!empty($_SESSION['work_permit_success_message'])): ?>
            <div class="message success">
                <?php echo htmlspecialchars($_SESSION['work_permit_success_message']);
    unset($_SESSION['work_permit_success_message']); ?>
            </div>
        <?php
endif; ?>
