                ...
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <div style='text-align: center; margin: 30px 0;'>
                            ...
                            <a href='http://localhost/Jai/XentroMall/admin_unified_renewal.php' class='action-button'>
                                Review Request →
                            </a>
                        </div>
...
<body>
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p><?php echo $isExistingTenant ? 'Submit your renewal documents for admin review' : 'Apply for a stall at XentroMall'; ?>
            </p>
        ...
        <form
            action="unified_renewal_form.php<?php echo isset($_GET['stall_id']) ? '?stall_id=' . htmlspecialchars($_GET['stall_id']) : ''; ?>"
            ...
            <?php if ($isExistingTenant): ?>
                ...
                <input type="hidden" name="company_name"
                    value="<?php echo htmlspecialchars($tenantData['company_name'] ?? ''); ?>">
                <input type="hidden" name="business_address"
                    value="<?php echo htmlspecialchars($tenantData['business_address'] ?? ''); ?>">
                <input type="hidden" name="contact_person"
                    value="<?php echo htmlspecialchars($tenantData['contact_person'] ?? ''); ?>">
                ...
                <?php if ($isExistingTenant && $tenantData): ?>
                    <div class="tenant-info">
                        ...
                        <p><strong>Contact Person:</strong>
                            <?php echo htmlspecialchars($tenantData['contact_person'] ?? 'N/A'); ?></p>
                        ...
                        <select name="stall_id" id="stall_id" required onchange="updatePaymentSummary()">
                            ...
                            <?php foreach ($availableStalls as $stall): ?>
                                <option value="<?php echo $stall['id']; ?>" data-rate="<?php echo $stall['monthly_rate']; ?>">
                                    ...
                                    ₱<?php echo number_format($stall['monthly_rate'], 2); ?>/month
                                    (<?php echo htmlspecialchars($stall['floor_area']); ?>)
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
            ...
            <div class="form-section">
                ...
                <div
                    class="business-type-container <?php echo ($isExistingTenant && $mappedType !== 'unknown') ? 'hidden' : ''; ?>">
                    ...
                    <div class="flex flex-col md:flex-row md:space-x-8 space-y-3 md:space-y-0">
                        <label class="inline-flex items-center cursor-pointer text-blue-700 font-medium">
                            <input name="business_type" id="type_corp" onclick="toggleRequirements()" <?php echo (!$isExistingTenant || $mappedType === 'unknown') ? 'required' : ''; ?> type="radio"
                                value="corporation" />
                            <span>Corporation</span>
                        </label>
                        <label class="inline-flex items-center cursor-pointer text-blue-700 font-medium">
                            <input name="business_type" id="type_sole" onclick="toggleRequirements()" type="radio"
                                value="sole_proprietorship" />
                            <span>Sole Proprietorship</span>
                        </label>
                        <label class="inline-flex items-center cursor-pointer text-blue-700 font-medium">
                            <input name="business_type" id="type_partner" onclick="toggleRequirements()" type="radio"
                                value="partnership" />
                            <span>Partnership</span>
                        </label>
                    </div>
                    <?php if ($isExistingTenant && $mappedType === 'unknown'): ?>
                        <p class="text-xs text-amber-600 mt-2 italic"><i class="fas fa-info-circle mr-1"></i> We couldn't
                            automatically determine your business type. Please select one to continue.</p>
                    <?php endif; ?>
                </div>

                <?php if ($isExistingTenant && $mappedType !== 'unknown'): ?>
                    <input type="hidden" name="business_type" id="hidden_business_type"
                        value="<?php echo htmlspecialchars($mappedType); ?>">
                <?php endif; ?>
                ...
                <div id="document-upload-section">
                    <div id="corporation-files" class="hidden file-upload-container">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">Letter of Intent/Concept Papers
                                    <span class="text-red-500">*</span></label>
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="letter_of_intent" type="file" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="business_profile" type="file" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="business_registration" type="file" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="secretary_certificate" type="file" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="bir_registration" type="file" accept=".pdf,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">Valid ID #1 with Specimen
                                    Signatures <span class="text-red-500">*</span></label>
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="valid_id" type="file" accept=".jpg,.jpeg,.png,.pdf" />
                            </div>
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">Valid ID #2 with Specimen
                                    Signatures <span class="text-red-500">*</span></label>
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="valid_id_2" type="file" accept=".jpg,.jpeg,.png,.pdf" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="sole_proprietorship-files" class="hidden file-upload-container">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="letter_of_intent_sole" type="file" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="business_registration_sole" type="file"
                            ...
                            <div>
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="bir_registration_sole" type="file" accept=".pdf,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">Valid ID #1 with Specimen
                                    Signatures <span class="text-red-500">*</span></label>
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="valid_id_sole_1" type="file" accept=".jpg,.jpeg,.png,.pdf" />
                            </div>
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">Valid ID #2 with Specimen
                                    Signatures <span class="text-red-500">*</span></label>
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="valid_id_sole_2" type="file" accept=".jpg,.jpeg,.png,.pdf" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="partnership-files" class="hidden file-upload-container">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="letter_of_intent_partner" type="file"
                                    accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">DTI Permit <span
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="business_registration_partner" type="file"
                                    accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">Partnership Agreement <span
                                        class="text-red-500">*</span></label>
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="financial_statement_partner" type="file"
                                    accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">BIR Form 2303 <span
                                ...
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="bir_registration_partner" type="file" accept=".pdf,.jpg,.jpeg,.png" />
                            </div>
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">Valid ID #1 with Specimen
                                    Signatures <span class="text-red-500">*</span></label>
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="valid_id_partner_1" type="file" accept=".jpg,.jpeg,.png,.pdf" />
                            </div>
                            <div>
                                <label class="block text-green-700 font-semibold mb-1">Valid ID #2 with Specimen
                                    Signatures <span class="text-red-500">*</span></label>
                                <input
                                    class="w-full rounded-md border border-blue-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400"
                                    name="valid_id_partner_2" type="file" accept=".jpg,.jpeg,.png,.pdf" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <button type="submit" name="submit_renewal_request" class="submit-btn">
                ...
                <?php echo $isExistingTenant ? 'Renewal Request' : 'Application'; ?>
            </button>
        </form>
    </div>
