 ...
 */
function sendPaymentReminder($userId, $dueDate, $amount = null) {
    global $pdo;
    ...
    try {
        ...
        if (!empty($email)) {
            $results['email'] = sendPaymentReminderEmail($email, $tradename, $dueDate, $amount);
        } else {
        ...
        if (!empty($mobile)) {
            $sms = new IPROG_SMS();
            $smsResult = $sms->sendPaymentReminderSMS($tradename, $mobile, $dueDate, $amount);
 ...
 */
function sendPaymentReminderEmail($recipientEmail, $tradename, $dueDate, $amount = null) {
            ...
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <div style='text-align: center;'>
                        <a href='http://localhost/Jai/XentroMall/tenant_dashboard.php' class='btn'>View Dashboard & Pay</a>
                    </div>
