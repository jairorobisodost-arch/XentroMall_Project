            ...
            if (move_uploaded_file($_FILES['payment_proof']['tmp_name'], $targetPath)) {
                ...
                $stmtPayment = $pdo->prepare("
                    INSERT INTO payments (
                        ...
                        billing_month, payment_image, payment_date, status,
                ...
                try {
                    ...
                    $mail->isHTML(true);
                    $mail->Subject = "Renewal Payment Submitted - " . ($renewal['tradename'] ?? 'Unknown');
                    $mail->Body = "
                        <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;'>
                            <div style='background: linear-gradient(135deg, #3b82f6 0%, #1e40af 100%); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;'>
                                <h1 style='margin: 0; font-size: 28px;'>💳 Renewal Payment Submitted</h1>
                                <p style='margin: 10px 0 0; font-size: 16px;'>New renewal payment received for approval</p>
                            </div>
                            <div style='background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px;'>
                                <h2 style='color: #1f2937; margin-bottom: 20px;'>Payment Details:</h2>
                                <p style='color: #4b5563; margin-bottom: 10px;'><strong>Tenant:</strong> " . htmlspecialchars($renewal['tradename']) . "</p>
                                <p style='color: #4b5563; margin-bottom: 10px;'><strong>Monthly Rent:</strong> ₱" . number_format($monthlyRate, 2) . "</p>
                                <p style='color: #4b5563; margin-bottom: 10px;'><strong>Payment Type:</strong> Renewal - Monthly Payment (NOT 3 months advance)</p>
                                <p style='color: #4b5563; margin-bottom: 10px;'><strong>Billing Month:</strong> " . $currentMonth . "</p>
                                <p style='color: #4b5563; margin-bottom: 20px;'><strong>Payment Proof:</strong> Uploaded</p>
                ...
                header('Location: submit_renewal_payment.php');
                exit;
            }
        } else {
