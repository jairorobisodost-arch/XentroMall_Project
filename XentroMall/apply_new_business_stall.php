        ...
        <div class="glass-effect rounded-2xl p-6 mb-6 shadow-xl">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Apply for Stall <?= htmlspecialchars($stall['stall_number']) ?> with different business</p>
                </div>
                <a href="apply_additional_stall.php" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg transition">
        ...
        <form method="POST" enctype="multipart/form-data" class="glass-effect rounded-2xl p-8 shadow-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="tradename" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="company_name" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <select name="business_type" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                ...
                <div>
                    ...
                    <input type="text" name="tin" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div>
                            <label for="addr_house" class="block text-xs text-gray-600 mb-1">House/Unit, Building</label>
                        ...
                        <div>
                            ...
                            <input type="text" name="addr_street" id="addr_street" required
                                   placeholder="Street"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                        </div>
                        <div>
                            <label for="addr_barangay" class="block text-xs text-gray-600 mb-1">Barangay</label>
                            <input type="text" name="addr_barangay" id="addr_barangay" required
                ...
                <div>
                    ...
                    <input type="text" name="store_premises" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="store_location" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>

                <!-- Ownership / Business Structure -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        <i class="fas fa-building mr-1"></i> Business Structure / Ownership <span class="text-red-500">*</span>
                    </label>
                    <select name="ownership" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                    ...
                    <p class="text-xs text-gray-500 mt-1">
                        ...
                        <strong>Note:</strong> Corporation/Partnership/Cooperative requires SEC, Sole Proprietorship requires DTI, Franchisee requires Franchise Agreement
                    </p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="office_tel" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="first_name" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="last_name" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="tenant_representative" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="contact_person" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="position" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="contact_tel" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="mobile" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="email" name="email_tenant" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="prepared_by" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent">
                </div>
            </div>
                ...
                <div id="corporation-files" class="hidden space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="file" name="letter_intent" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Company Profile <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="company_profile" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                SEC Registration <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="sec_registration" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Secretary's Certificate <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="secretary_certificate" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                BIR Form 2303 <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="bir_2303" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Valid ID #1 with Specimen Signatures <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="valid_id_1" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Valid ID #2 with Specimen Signatures <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="valid_id_2" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                    </div>
                </div>
                ...
                <div id="sole-files" class="hidden space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="file" name="letter_intent_2" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                DTI Permit <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="dti_permit_2" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                BIR Form 2303 <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="bir_2303_2" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Valid ID #1 with Specimen Signatures <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="valid_id_1_sole" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Valid ID #2 with Specimen Signatures <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="valid_id_2_sole" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                    </div>
                </div>
                ...
                <div id="franchisee-files" class="hidden space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="file" name="letter_intent_3" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Enrollment Letter from Franchisor <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="enrollment_letter_3" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Photocopy of Franchise Agreement <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="franchise_agreement_3" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                BIR Form 2303 <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="bir_2303_3" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Valid ID #1 with Specimen Signatures <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="valid_id_1_franchisee" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">
                                Valid ID #2 with Specimen Signatures <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="valid_id_2_franchisee" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 flex gap-4">
                <button type="submit" class="flex-1 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white font-bold py-4 px-6 rounded-lg transition transform hover:scale-105 shadow-lg">
                    <i class="fas fa-paper-plane mr-2"></i> Submit Application
                </button>
                <a href="apply_additional_stall.php" class="px-6 py-4 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold rounded-lg transition">
