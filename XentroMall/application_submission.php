...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Get tenant information including previous application status
                ...
                <div class='container'>
                    ...
                    <div class='content'>
                        <p style='font-size: 16px; color: #1f2937; margin-bottom: 20px;'>
                            <strong>" . ($isResubmission ? 'Update!' : 'Good news!') . "</strong> " . 
                            ($isResubmission && $previous_status === 'declined' 
                                ? "<strong style='color: #f59e0b;'>$tradename</strong> has resubmitted their application documents after being <strong style='color: #ef4444;'>DECLINED</strong>." 
                                : "A tenant has " . ($isResubmission ? 'resubmitted' : 'submitted') . " application documents") . 
...
<body>
    ...
    <form action="application_submission.php" method="POST" enctype="multipart/form-data">
        ...
        <?php if ($existingExtendedBir): ?>
            <div class="preview">
                Previous Extended BIR Registration: <a href="<?php echo htmlspecialchars($existingExtendedBir); ?>" target="_blank"><?php echo htmlspecialchars(basename($existingExtendedBir)); ?></a>
            </div>
        <?php endif; ?>
