...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($type === 'single') {
            ...
            if ($tenant) $tenantsToNotify[] = $tenant;
        } else {
                ...
                <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;'>
                    <div style='max-width: 600px; margin: 20px auto; padding: 30px; border: 1px solid #e2e8f0; border-radius: 16px; background-color: #ffffff; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);'>
                        ...
                        <div style='text-align: center; margin: 35px 0;'>
                            <a href='http://localhost/Jai/XentroMall/login.php' style='background-color: #0ea5e9; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 10px; font-weight: 700; font-size: 16px; display: inline-block; box-shadow: 0 4px 6px rgba(14, 165, 233, 0.2);'>Access Tenant Dashboard</a>
                        </div>
