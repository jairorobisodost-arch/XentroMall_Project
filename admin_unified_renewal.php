                ...
                if ($action === 'approve') {
                        ...
                        <div class='container'>
                            ...
                            <div class='content'>
                                ...
                                <div style='text-align: center; margin: 30px 0;'>
                                    <a href='" . BASE_URL . "tenant_dashboard.php' class='action-button'>
                                        Go to Dashboard →
                                    </a>
                                </div>
                            </div>
                    ...
                    $mail->Body .= "
                        ...
                        <div style='text-align: center; margin: 30px 0;'>
                            ...
                            <a href='" . BASE_URL . "unified_renewal_form.php' class='action-button'>
                                Resubmit →
                            </a>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-4">
                        <a href="admin_dashboard.php"
                            class="flex items-center gap-2 text-white hover:text-purple-100 transition-colors">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    class="w-10 h-10 rounded-full flex items-center justify-center <?php echo $request['request_type'] === 'renewal' ? 'bg-emerald-100' : 'bg-blue-100'; ?>">
                                                    <i
                                                        class="fas <?php echo $request['request_type'] === 'renewal' ? 'fa-sync-alt text-emerald-600' : 'fa-file-alt text-blue-600'; ?>"></i>
                                                </div>
                                                <div>
                                                    <div class="text-sm font-medium text-gray-900">
                                                        <?php echo htmlspecialchars($request['tradename']); ?></div>
                                                    <div class="text-xs text-gray-500">
                                                        <?php echo htmlspecialchars($request['username']); ?></div>
                                                    <span
                                                        class="inline-block mt-1 px-2 py-0.5 rounded text-xs font-medium <?php echo $request['request_type'] === 'renewal' ? 'bg-emerald-100 text-emerald-800' : 'bg-blue-100 text-blue-800'; ?>">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm">
                                                <div class="font-medium text-gray-900">
                                                    ₱<?php echo number_format($request['total_amount'], 2); ?></div>
                                                <div class="text-xs text-gray-500">
                                                    <?php
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo $request['account_action'] === 'create_new' ? 'bg-blue-100 text-blue-800' : 'bg-emerald-100 text-emerald-800'; ?>">
                                                <i
                                                    class="fas <?php echo $request['account_action'] === 'create_new' ? 'fa-plus-circle' : 'fa-check-circle'; ?>"></i>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            ?>
                                            <span
                                                class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium <?php echo $statusClasses[$request['status']]; ?>">
                                            ...
                                            <?php if (!empty($request['payment_proof'])): ?>
                                                <div class="mt-1">
                                                    <span
                                                        class="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-bold bg-amber-100 text-amber-800 border border-amber-200">
                                                        <i class="fas fa-receipt"></i> RECEIPT UPLOADED
                                                    </span>
                                                </div>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center gap-2">
                                                <button
                                                    onclick="viewDocuments(<?php echo htmlspecialchars(json_encode($request)); ?>)"
                                                ...
                                                <?php if ($request['status'] === 'pending'): ?>
                                                    <button
                                                        onclick="openApprovalModal(<?php echo htmlspecialchars(json_encode($request)); ?>)"
                                                    ...
                                                    <button
                                                        onclick="openDeclineModal(<?php echo htmlspecialchars(json_encode($request)); ?>)"
    ...
    <div id="approvalModal"
        ...
        <div class="bg-white rounded-xl w-full max-w-md overflow-hidden">
            ...
            <form method="POST" class="p-6 space-y-4">
                ...
                <div>
                    <label for="admin_feedback" class="block text-sm font-medium text-gray-700 mb-2">Admin Feedback
                        (Optional)</label>
    ...
    <div id="declineModal"
        ...
        <div class="bg-white rounded-xl w-full max-w-md overflow-hidden">
            ...
            <form method="POST" class="p-6 space-y-4">
                ...
                <div>
                    <label for="decline_feedback" class="block text-sm font-medium text-gray-700 mb-2">Reason for
                        Decline *</label>
    ...
    <script>
        ...
        function viewDocuments(request) {
            ...
            const documents = [
                ...
                { name: 'Payment Proof (Receipt)', field: 'payment_proof' }
            ];
