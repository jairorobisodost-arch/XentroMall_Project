        ...
        <div class="glass-effect rounded-3xl shadow-2xl p-6 mb-6 animate-fade-in">
            <div class="flex items-center justify-between flex-wrap gap-4">
                ...
                <div class="flex items-center gap-3">
                    <a href="admin_dashboard.php" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-3 rounded-xl transition-all flex items-center gap-2 font-medium shadow-sm">
                        <i class="fas fa-arrow-left"></i>
                        <span>Back to Dashboard</span>
                    </a>
                    <?php if (!isset($_GET['edit']) && !isset($_GET['create'])): ?>
                    <a href="?create" class="gradient-primary hover:opacity-90 text-white px-6 py-3 rounded-xl transition-all flex items-center gap-2 font-medium shadow-lg">
